...
const (
	...
	CERTEX_DEF_BASE = uint(0x8E000000)
	/* Key types: */

	/* GOST 28147.89 */
	CKK_CERTEX_GOST_28147_89 = (CERTEX_DEF_BASE + 0x00000001)

	/* RDS - GOST R 34.10-2001 */
	CKK_CERTEX_RDS = (CERTEX_DEF_BASE + 0x00000002)

	/*  Attributes: */
	CKA_CERTEX_GET_LOG_LEVEL = (CERTEX_DEF_BASE + 0x00000000)
	CKA_CERTEX_SET_LOG_LEVEL = (CERTEX_DEF_BASE + 0x00000001)

	// of type CK_CERTEX_DATETIME
	CKA_CERTEX_KEY_GENERATION_DATE = (CERTEX_DEF_BASE + 0x00000002)

	/* Substitution block for GOST 28147.89   */
	CKA_CERTEX_SBLOCK = (CERTEX_DEF_BASE + 0x00000003)

	/* GOST R 34.10-2001 attributes: */
	CKA_CERTEX_RDS_PRM_P = (CERTEX_DEF_BASE + 0x0000000B)
	CKA_CERTEX_RDS_PRM_A = (CERTEX_DEF_BASE + 0x0000000C)
	CKA_CERTEX_RDS_PRM_B = (CERTEX_DEF_BASE + 0x0000000D)
	CKA_CERTEX_RDS_PRM_Q = (CERTEX_DEF_BASE + 0x0000000E)
	CKA_CERTEX_RDS_PRM_X = (CERTEX_DEF_BASE + 0x0000000F)
	CKA_CERTEX_RDS_PRM_Y = (CERTEX_DEF_BASE + 0x00000010)
	CKA_CERTEX_RDS_TYPE  = (CERTEX_DEF_BASE + 0x00000011)

	/* GOST 28147.89 */
	CKM_CERTEX_GOST_28147_89_KEY_GEN = (CERTEX_DEF_BASE + 0x00000000)
	CKM_CERTEX_GOST_28147_89_ECB     = (CERTEX_DEF_BASE + 0x00000001)
	CKM_CERTEX_GOST_28147_89_OFB     = (CERTEX_DEF_BASE + 0x00000002)
	CKM_CERTEX_GOST_28147_89_CFB     = (CERTEX_DEF_BASE + 0x00000003)
	CKM_CERTEX_GOST_28147_89_MAC     = (CERTEX_DEF_BASE + 0x00000004)

	/* Hash for GOST R 34.11-94 / 2012 */
	CKM_CERTEX_GOSTR3411         = (CERTEX_DEF_BASE + 0x0000000A) // соответствует  "1.2.398.3.10.1.3.1.1.0"
	CKM_CERTEX_GOSTR3411_2012_32 = (CERTEX_DEF_BASE + 0x00000010) // соответствует  "1.2.398.3.10.1.3.2"
	CKM_CERTEX_GOSTR3411_2012_64 = (CERTEX_DEF_BASE + 0x00000011) // соответствует  "1.2.398.3.10.1.3.3"

	/* GOST R 34.10-2001/2012  keypair generation mechanism */
	CKM_CERTEX_GOSTR3410_2001_KEY_PAIR_GEN = (CERTEX_DEF_BASE + 0x0000000B)
	CKM_CERTEX_GOSTR3410_2012_KEY_PAIR_GEN = (CERTEX_DEF_BASE + 0x00000012)

	/* GOST R 34.10-2001/2012 'raw' mechanism */
	CKM_CERTEX_GOSTR3410_2001 = (CERTEX_DEF_BASE + 0x0000000C) // соответствует "1.2.398.3.10.1.1.1.2"
	CKM_CERTEX_GOSTR3410_2012 = (CERTEX_DEF_BASE + 0x00000013) // соответствует "1.2.398.3.10.1.1.2.3"
	CKM_CERTEX_GOSTR3410_2015 = CKM_CERTEX_GOSTR3410_2012

	/* GOST R 34.11-94(2012) hash with GOST R 34.10-2001/2012 mechanism */
	CKM_CERTEX_GOSTR3411_94_GOSTR3410_2001 = (CERTEX_DEF_BASE + 0x0000000D)
	CKM_CERTEX_GOSTR3411_GOSTR3410_2012    = (CERTEX_DEF_BASE + 0x00000014)
	CKM_CERTEX_GOSTR3411_GOSTR3410_2015    = CKM_CERTEX_GOSTR3411_GOSTR3410_2012
